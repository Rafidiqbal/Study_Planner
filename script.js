...
"Physics": Array.from({ length: 10 }, (, i) => ({ name: Topic ${i + 1}, done: 0, total: 10 })),
"Chemistry": Array.from({ length: 10 }, (, i) => ({ name: Topic ${i + 1}, done: 0, total: 10 })),
"Biology": Array.from({ length: 10 }, (, i) => ({ name: Topic ${i + 1}, done: 0, total: 10 })),
"Higher Math": Array.from({ length: 10 }, (, i) => ({ name: Topic ${i + 1}, done: 0, total: 10 }))
};
